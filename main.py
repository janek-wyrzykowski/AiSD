...
def main():
    ...
    nx.draw_networkx_nodes(G, pos, node_color=['#C1121F' if G.nodes[n]['toVisit'] else '#669BBC' for n in G.nodes], node_size=300)
    ...
    nx.draw_networkx_nodes(H, pos, node_color='#C1121F', node_size=300)
